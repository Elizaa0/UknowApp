  ...
  useEffect(() => {
    ...
    if (savedSettings) {
      ...
      const themes = [
        ...
        { id: 'dark', name: 'Ciemny', colors: { primary: '#2c3e50', secondary: '#34495e', background: '#23272f', panel: '#2c3e50', text: '#f5f7fa' } },
        { id: 'purple', name: 'Fioletowy', colors: { primary: '#9b59b6', secondary: '#8e44ad', background: '#f5e9ff', panel: '#fff', text: '#2c3e50' } },
      ];
